...
class MangaRoomService:
    ...
    def get_manga_room_by_id(self, room_id: int) -> MangaRoom | None:
        return self.manga_room_repository.get_by_id(room_id=room_id)
    ...
    def update_manga_room(self, room_id: int, manga_room_update: MangaRoomUpdate) -> MangaRoom | None:
        return self.manga_room_repository.update(room_id=room_id, manga_room_update=manga_room_update)

    def delete_manga_room(self, room_id: int) -> MangaRoom | None:
        return self.manga_room_repository.delete(room_id=room_id)